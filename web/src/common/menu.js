...
const getMainLinks = (routes, user = null) => routes.filter(item => {
   ...
   if(menus && menus.length) {
      ...
      if(user) return mainMenu.show !== GUEST_ONLY;
      else return mainMenu.show !== USER_ONLY;      
   }
   return false;
});
...
const getFooterLinks = (routes, user = null) => routes.filter(item => {
   ...
   if(menus && menus.length) {
      ...
      if(user) return footerMenu.show !== GUEST_ONLY;
      else return footerMenu.show !== USER_ONLY;
